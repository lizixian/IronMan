...
class AppInfoFragment : BaseFragment() {
    ...
    override fun init() {
        ...
        val adapter = SlimAdapter.create().register(R.layout.item_appinfo,
            SlimInjector<AppInfo> { data, injector ->
                injector.text(R.id.title, data.title).text(R.id.desc, data.desc)
...
data class AppInfo(var title: String, var desc: String)